              ...
              return (
                ...
                >
                  ...
                  <Box sx={{ textAlign: 'center', mt: 1 }}>
                    ...
                    {movie.source && (
                      <Chip
                        label={SOURCE_NAMES[movie.source] || movie.source}
                        size="small"
                        sx={{
                          mt: 1,
                          height: 20,
                          fontSize: 10,
                          fontWeight: 600,
                          backgroundColor: SOURCE_COLORS[movie.source] || '#666',
                          color: '#fff',
                          '&:hover': {
                            backgroundColor: SOURCE_COLORS[movie.source] || '#666',
                          }
            ...
            >
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2, mt: 2 }}>
                <Button
                  ...
                  onClick={() => {
                    const movieRoute = displayMovies[hovered].slug || displayMovies[hovered].sourceSlug || displayMovies[hovered].title_url || displayMovies[hovered].id;
