...
const animehayListItemSchema = z.object({
...
const animehayDetailSchema = animehayListItemSchema.extend({
...
const animehayListResponseSchema = z.object({
  status: z.string().optional(),
  items: z.array(animehayListItemSchema).optional(),
  paginate: z.object({
...
const animehayDetailResponseSchema = z.object({
  status: z.string().optional(),
  movie: animehayDetailSchema.optional()
}).passthrough();

module.exports = {
  animehayListResponseSchema,
  animehayDetailResponseSchema
};
