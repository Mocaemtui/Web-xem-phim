              ...
              <div style={{ display: 'flex', gap: 40, alignItems: 'flex-start' }}>
                <form style={{ flex: 1, maxWidth: 400 }} onSubmit={handleUpdate}>
                  <div className="profile-form-row">
                    ...
                    <input type="email" id="profile-email" name="email" value={email} disabled className="profile-form-input" />
                  </div>
                  <div className="profile-form-row">
                    <div className="profile-form-label">Tên hiển thị</div>
                    <input type="text" id="profile-display-name" name="displayName" value={displayName} onChange={e => setDisplayName(e.target.value)} className="profile-form-input" />
                  </div>
                  <div className="profile-form-row">
                ...
                <form onSubmit={handleChangePassword} style={{
                  ...
                  <div style={{ marginBottom: 18 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', background: '#181A20', borderRadius: 10, border: '1.5px solid #232a3b', transition: 'border 0.18s' }}>
                      <input type={showOld ? 'text' : 'password'} id="old-password" name="oldPassword" value={oldPassword} onChange={e => setOldPassword(e.target.value)}
                  ...
                  <div style={{ marginBottom: 18 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', background: '#181A20', borderRadius: 10, border: '1.5px solid #232a3b', transition: 'border 0.18s' }}>
                      <input type={showNew ? 'text' : 'password'} id="new-password" name="newPassword" value={newPassword} onChange={e => setNewPassword(e.target.value)}
                        style={{ flex: 1, background: 'transparent', border: 'none', color: '#fff', padding: '12px 14px', fontSize: 16, borderRadius: 10, fontWeight: 500, fontFamily: 'inherit', outline: 'none' }}
                        onFocus={e => e.target.parentNode.style.border = '1.5px solid #fff'}
                        onBlur={e => e.target.parentNode.style.border = '1.5px solid #232a3b'}
                      />
                  ...
                  <div style={{ marginBottom: 24 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', background: '#181A20', borderRadius: 10, border: '1.5px solid #232a3b', transition: 'border 0.18s' }}>
                      <input type={showConfirm ? 'text' : 'password'} id="confirm-password" name="confirmPassword" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)}
                        style={{ flex: 1, background: 'transparent', border: 'none', color: '#fff', padding: '12px 14px', fontSize: 16, borderRadius: 10, fontWeight: 500, fontFamily: 'inherit', outline: 'none' }}
                        onFocus={e => e.target.parentNode.style.border = '1.5px solid #fff'}
                        onBlur={e => e.target.parentNode.style.border = '1.5px solid #232a3b'}
                      />
